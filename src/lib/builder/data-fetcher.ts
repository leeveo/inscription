...
/**
 * Execute a Supabase query based on DataBinding configuration
 * Supports SELECT, WHERE, ORDER BY, and LIMIT clauses
 */
export async function fetchBoundData<T = any>(
      ...
      binding.where.forEach(clause => {
        switch (clause.operator) {
          ...
          case 'like':
            ...
            break;
          case 'in':
            // Assume value is comma-separated string or array
